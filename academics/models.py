...
class Department(models.Model):
    ...
    hod = models.OneToOneField(
        ...
        null=True,
        blank=True,
        limit_choices_to={'role__in': ['HOD', 'FACULTY']}, # This will show both HODs and Faculty
...
class Course(models.Model):
    ...
    class Meta:
        ...
        unique_together = ('code', 'academic_year') # A course code should be unique per academic year
        ordering = ['academic_year__start_date', 'code'] # Order by academic year then code
...
class COPOMapping(models.Model):
    ...
    def __str__(self):
        ...
        return f"{self.course_outcome.code} maps to {self.program_outcome.code} ({level})"
...
class AssessmentType(models.Model):
    name = models.CharField(max_length=100, unique=True, help_text="e.g., Midterm Exam, Assignment, Project, Quiz")
...
class Assessment(models.Model):
    name = models.CharField(max_length=200, help_text="e.g., Midterm Exam - Unit 1, Assignment 2 - Loops")
    course = models.ForeignKey(
        Course,
    ...
    max_marks = models.DecimalField(max_digits=5, decimal_places=2, help_text="Maximum marks for this assessment")
    ...
    class Meta:
        ...
        unique_together = ('name', 'course', 'academic_year') # Assessment name must be unique per course and year
...
class StudentMark(models.Model):
    ...
    marks_obtained = models.DecimalField(max_digits=5, decimal_places=2, help_text="Marks obtained by the student")
    ...
    class Meta:
        ...
        unique_together = ('assessment', 'student') # Each student can only have one mark per assessment
...
class CourseOutcomeAttainment(models.Model):
    ...
    attainment_percentage = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
